...
#' @param group_by A string - the grouping variable in the metadata to plot.
...
#' @param split_by A string - by which metadata variable the plot will be split.
#' @param pal_setup A dataframe with 2 columns - the \code{RColorBrewer} palette setup to be used;
#' 
#' Or a string vector of \code{RColorBrewer} palettes. Multiple palettes can be specified, in case of many levels to be colored; 
#' 
...
#' @param group_by A string - the grouping variable for plot in the metadata.
#' @param pal_setup A dataframe with 2 columns - the \code{RColorBrewer} palette setup to be used; 
#' 
#' or a string vector of \code{RColorBrewer} palettes. Multiple palettes can be specified, in case of many levels to be colored; 
#' 
#' or a string vector of colors.
#' @param plot_ratio A double - the aspect ratio of the plot.
#' @param text_size A double - the text size of the plot.
