...
#' 
#' Or a string vector of \code{RColorBrewer} palettes. Multiple palettes can be specified, in case of many levels to be colored;
#'  
#' Or a string vector of colors.
#' 
#' @return A plot.
...
#' 
#' @param dataset A Seurat object.
#' @param measures A string vector - the names of genes or measures to be plotted.
#' @param split_by A string - the splitting variable in the metadata.
...
#' 
#' @param dataset A Seurat object.
#' @param markers A tibble - the dataframe generated by \code{FindAllMarkers} function in \code{Seurat};
#' 
#' Or a character vector - the names of genes can be directly specified.
#' @param sort_var A string vector - the variables to be sorted in the heatmap, should exist in the \code{metadata} of the \code{dataset}.
...
#' @param anno_var A string vector - the variables in the annotation, should exist in the \code{metadata} of the \code{dataset}.
...
#' It can also be a string vector with three color values, corresponding to the \code{min}, \code{median}, and \code{max} values of the numeric variable. 
#' 
...
#' 
#' or a string vector of colors.
#' @param plot_ratio A numeric - the aspect ratio of the plot.
#' @param text_size A numeric - the text size of the plot.
#' @param tilt_text A logical - whether the x axis label text is tilted.
#' 
#' @return A plot.
...
#' 
#' @param gsea_res A tibble - the results of GSEA generated by \code{test_GSEA}.
#' @param pattern A string - the prefix string pattern to be trimmed of pathway names.
#' @param p_cutoff A numeric - the p-value cutoff for significance.  
#' @param colors A string vector - three color values, corresponding to the \code{low}, \code{mid}, and \code{high} of the color gradient.
#' 
#' @return A plot.
