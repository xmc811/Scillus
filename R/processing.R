...
#' 
#' @param dir A string - directory path generated by 10xGenomics pipeline.
#' @param raw_data A string - file path of single cell RNA-Seq count matrix.
#' @param gcol An integer - the column index of feature names in the 10xGenomics folder.
#' @param proj_name A string - name of the biological sample.
#' @param min_cells An integer - include features detected in at least this many cells.
#' @param org A string - name of organism. Currently only "human" or "mouse" are accepted.
#' @param cc A logcial value - if cell cycle scores are calculated
#' 
